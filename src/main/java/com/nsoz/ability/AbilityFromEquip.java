...
public class AbilityFromEquip implements AbilityStrategy {
    ...
    public void setAbility(Char owner) {
        ...
        owner.exactly = owner.potential[1] + (owner.potential[1] * owner.options[58] / 100) + (owner.potential[1] * owner.options[197] / 100) + owner.options[57] + owner.options[12] + owner.options[196];
        owner.miss = (owner.potential[1] + owner.options[57] + owner.options[196] + owner.options[196] + (owner.potential[1] * owner.options[58] / 100) + (owner.potential[1] * owner.options[197] / 100)) * 150 / 100;
        switch (owner.getSideClass()) {
            case 0:
                potentialDame = ((owner.potential[0] + owner.options[57]  + owner.options[196]) + (owner.potential[0] * owner.options[58] / 100) + (owner.potential[0] * owner.options[197] / 100));
            ...
            case 1:
                potentialDame = (owner.potential[3] + owner.options[57] + owner.options[196] + (owner.potential[3] * owner.options[58] / 100) + (owner.potential[3] * owner.options[197] / 100));
                owner.basicAttack = potentialDame + owner.options[38] + (potentialDame * skillOptions[11] / 100);
                if (owner.incrDame > 0) {
                    owner.basicAttack += potentialDame * owner.incrDame / 100;
                }
        ...
        owner.damage += potentialDame * owner.incrDame4 / 100;
        
        owner.damage += owner.options[73] + owner.options[87] + owner.options[76] + owner.options[168] + owner.options[179];
        ...
        switch (owner.getSys()) {
            case 1:
                owner.damage += owner.options[88] + owner.options[183];
                break;

            case 2:
                owner.damage += owner.options[89] + owner.options[184];
                break;

            case 3:
                owner.damage += owner.options[90] + owner.options[185];
                break;
        }
        ...
        owner.maxHP += owner.options[188];

        owner.maxHP += (owner.maxHP * owner.options[128] / 100); // tăng % hp sau khi mặc đồ
        owner.maxHP += (owner.maxHP * owner.options[160] / 100);
        ...
        owner.hutHPfromMobs += owner.options[198];
        owner.hutHPfromMobsPer += owner.options[199];
        owner.hutMPfromMobs += owner.options[200];
        owner.hutMPfromMobsPer += owner.options[201];
        owner.dameDown = owner.options[47] + owner.options[74] + owner.options[80] + owner.options[124];
        owner.miss += owner.options[5] + owner.options[17] + owner.options[62] + owner.options[68] + owner.options[78] + owner.options[84] + owner.options[115] + owner.options[162] + owner.options[180]
                + owner.optionsSupportSkill[13];
        owner.exactly += owner.options[10] + owner.options[18] + owner.options[75] + owner.options[86] + owner.options[116] + owner.options[166] + owner.optionsSupportSkill[12] + owner.options[181];
        owner.resFire = owner.options[2] + owner.options[11] + owner.options[33] + owner.options[70] + owner.options[163]+ owner.options[96] + owner.optionsSupportSkill[19]
                + owner.optionsSupportSkill[20] + owner.options[36] + owner.options[118] + owner.options[195];
        owner.resIce = owner.options[3] + owner.options[12] + owner.options[34] + owner.options[71]+ owner.options[164] + owner.options[95] + owner.optionsSupportSkill[19]
                + owner.optionsSupportSkill[21] + owner.options[36] + owner.options[118] + owner.options[195];
        owner.resWind = owner.options[4] + owner.options[13] + owner.options[35] + owner.options[72] +  owner.options[165] + owner.options[97] + owner.optionsSupportSkill[19]
                + owner.optionsSupportSkill[22] + owner.options[36] + owner.options[118] + owner.options[195];
        owner.fatal = owner.options[14] + owner.options[37] + owner.options[69] + owner.options[92] + owner.options[114] + owner.optionsSupportSkill[14] + owner.options[167] + owner.options[182];
        owner.fatalDame = owner.options[105];
        owner.percentFatalDame = owner.options[39] + owner.options[67] + owner.options[186];
        owner.reactDame = owner.options[15] + owner.options[91] + owner.options[126] + owner.optionsSupportSkill[15] + owner.options[191];
        owner.sysDown = 0;
