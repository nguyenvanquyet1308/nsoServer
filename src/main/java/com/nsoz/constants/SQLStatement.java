...
//    public static final String GET_USER = "SELECT `status`, `id`, `luong`, `last_attendance_at`, `received_first_gift`, `password`, `ip_address`, `level_reward`, `role`, `online`,`kh`, `tongnap`, `isVIP`, `ban_until`, `activated` FROM `users` WHERE `username` = ?;";
    public static final String GET_USER = "SELECT `status`, `id`, `luong`, `last_attendance_at`, `received_first_gift`, `password`, `ip_address`, `level_reward`, `role`, `online`,`kh`, `tongnap`, `isVIP`, `ban_until`, `activated`, `nhan_v-vip`, `nhan_vip` FROM `users` WHERE `username` = ?;";
