...
public class Item {
    ...
    public void initOption() {
        ...
        else if (this.template.id >= 1184 && this.template.id <= 1185) {
            long expire = System.currentTimeMillis() + (long) 300000000;
            this.expire = expire;
            this.options.add(new ItemOption(87, 5000));// kinh nghiệm
            this.options.add(new ItemOption(82, 2000));// hồi phục hp
            this.options.add(new ItemOption(83, 2000));// hp tối đa
            this.options.add(new ItemOption(92, 50));// tấn công
        } 
        ...
        if (this.template.id == 440) {
                this.options.add(new ItemOption(85, 0));
                this.options.add(new ItemOption(87, 500));
            }
        if (this.template.id == 441) {
                this.options.add(new ItemOption(85, 0));
                this.options.add(new ItemOption(82, 500));
            }
        if (this.template.id == 442) {
                this.options.add(new ItemOption(85, 0));
                this.options.add(new ItemOption(84, 50));
            }
        if (this.template.id == 443) {
                this.options.add(new ItemOption(85, 0));
                this.options.add(new ItemOption(86, 50));
            }
        if (this.template.id == 486) {
                this.options.add(new ItemOption(85, 0));
                this.options.add(new ItemOption(87, 500));
            }
        if (this.template.id == 487) {
                this.options.add(new ItemOption(85, 0));
                this.options.add(new ItemOption(82, 500));
            }
        if (this.template.id == 488) {
                this.options.add(new ItemOption(85, 0));
                this.options.add(new ItemOption(84, 50));
            }
        if (this.template.id == 489) {
                this.options.add(new ItemOption(85, 0));
                this.options.add(new ItemOption(86, 50));
            }
            ...
            switch (this.id) {
                ...
                case ItemName.MAT_NA_JIRAI_, ItemName.MAT_NA_JUMITO -> {
                    switch (this.upgrade) {
                        case 4, 5, 6 ->
                ...
                case ItemName.AKATSUKI_NAM, ItemName.AKATSUKI_NU -> {
                    if (this.id == ItemName.AKATSUKI_NAM || this.id == ItemName.AKATSUKI_NU) {
                        switch (this.sys) {
                            case 1 ->
                    ...
                    if (this.upgrade == 6) {
                        ...
                        this.options.add(new ItemOption(94,  35));
                        ...
                        this.options.add(new ItemOption(94,  100));
                        this.options.add(new ItemOption(113, 1000));
                    }
                    this.options.add(new ItemOption(100, 50));
                }
                case ItemName.SANTA_CLAUS, ItemName.SUMIMURA_, ItemName.YUKIMURA_, ItemName.MAT_NA_MARADA -> {
                    this.options.add(new ItemOption(127, this.upgrade * 3));
                    this.options.add(new ItemOption(130, this.upgrade * 3));
                    this.options.add(new ItemOption(131, this.upgrade * 3));
    ...
    public void randomOption() {
        if (((this.id >= 814 && this.id <= 818) || this.id == ItemName.KHAU_TRANG) && this.options.isEmpty()) { // Halloween
            ...
            randomOptionMount();
                ...
                || this.id == ItemName.AO_TAN_THOI || this.id == ItemName.AO_NGU_THAN || this.id == 1184 || this.id == 1185)
    ...
    public void removeOptionThucTinh() {
        Vector<ItemOption> options = new Vector<>();
        boolean isArrivedLineGem = false;
        for (ItemOption option : this.options) {
            if (option.optionTemplate.id == 178 ||option.optionTemplate.id == 179 || option.optionTemplate.id == 180 || option.optionTemplate.id == 181
                || option.optionTemplate.id == 182 || option.optionTemplate.id == 183 || option.optionTemplate.id == 184 
                || option.optionTemplate.id == 185 || option.optionTemplate.id == 186 || option.optionTemplate.id == 187) {
                isArrivedLineGem = true;
                options.add(option);
                continue;
            }
