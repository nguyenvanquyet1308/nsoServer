...
public class TileMap {
    ...
    public boolean isNotPk() {
        return isLoiDai() || isChienTruong() || isDauTruong() || isFujukaSanctuary() || isCandyBattlefield() ||isGTC();
    }
    ...
    public boolean isGTC() {
        return id == MapName.BAO_DANH_GIA_TOC || id == MapName.BAO_DANH_GIA_TOC_2 || id == MapName.SANH_1 || id == MapName.SANH_2
                || id == MapName.HANH_LANG_1|| id == MapName.HANH_LANG_2|| id == MapName.HANH_LANG_3 || id == MapName.CAN_CU_DIA || id == MapName.CAN_CU_DIA_2;
    }
    ...
    public boolean isNotTeleport() {
        return isLoiDai() || isDauTruong() || isChienTruong() || isDungeo() || isDungeoClan() || isNhaThiDau()
                || isThatThuAi() || isFujukaSanctuary() || isCandyBattlefield() ||isGTC();
    }
    ...
    public boolean isDauTruong() {
     ...
     public boolean isChienTruong() {
        return type == MAP_CHIENTRUONG && id != MapName.BAO_DANH_GIA_TOC && id != MapName.BAO_DANH_GIA_TOC_2 && id != MapName.SANH_1 && id != MapName.SANH_2
