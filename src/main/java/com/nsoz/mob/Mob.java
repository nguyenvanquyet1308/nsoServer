...
public class Mob {
    ...
    public static final byte HANG_VI_THU= 16;
        ...
        try {
            ...
            if (type == ITEM) {
                ...
                if (itemId == ItemName.PHAN_THAN_LENH && this.level < 100) {
                    ...
                    itemId = RandomItem.HANG_VI_THU.next();
                }
            ...
            if (this.template.id == MobName.NGUOI_TUYET) {
                if (killer.clan != null) {
                    for (Char mem : killer.clan.getOnlineMembers()) {
                        mem.serverMessage(Char.setNameVip(killer.name) + " đã tiêu diệt người tuyết");
                ...
                if (this.isBoss) {
                    ...
                    }else if (zone.tilemap.id == 169) {
                        if ((int)NinjaUtils.nextInt(10) == 10) {
                            dropItem(killer, Mob.HANG_VI_THU);
                        }
                    }
...
//            if(this.levelBoss == 1){
//                zone.getService().addEffect(this, 33, 999, 999, 0);
//            }
//            if(this.levelBoss == 2){
//                zone.getService().addEffect(this, 208, 999, 999, 0);
//            }
//            if(this.levelBoss == 3){
//                zone.getService().addEffect(this, 209, 999, 999, 0);
//           }
            if(this.template.id == 222){
                zone.getService().addEffect(this, 210, 999, 999, 0);
                zone.getService().addEffect(this, 100, 999, 999, 0);
