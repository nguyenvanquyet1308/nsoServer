...
public class RandomItem {
    ...
    public static final RandomCollection<Integer> HANG_VI_THU = new RandomCollection<>();
    public static final RandomCollection<Integer> TUI_QUA_NOEL = new RandomCollection<>();
    ...
    public static void init() {
        ...
        BOSS_LANG_TRUYEN_THUYET.add(0.2, ItemName.BAT_BAO);
        BOSS_LANG_TRUYEN_THUYET.add(0.2, ItemName.RUONG_BACH_NGAN);
        BOSS_LANG_TRUYEN_THUYET.add(2, ItemName.RUONG_SVC_11X);
        BOSS_LANG_TRUYEN_THUYET.add(2, ItemName.CHUYEN_TINH_THACH);
        // Làng cổ
        LANG_CO.add(2, ItemName.THU_TRANG);
        LANG_CO.add(22, ItemName.GIAP_THU);
        LANG_CO.add(22, ItemName.YEN2);
        LANG_CO.add(22, ItemName.DAY_CUONG);
        LANG_CO.add(22, ItemName.BO_DIEU_KHIEN);
        LANG_CO.add(22, ItemName.DONG_CO_V_POWER);
        LANG_CO.add(22, ItemName.DINH_VI);
        LANG_CO.add(22, ItemName.BINH_NITRO);
        LANG_CO.add(1, ItemName.CHUYEN_TINH_THACH);
        LANG_CO.add(2, ItemName.TU_TINH_THACH_SO_CAP);
        LANG_CO.add(1, ItemName.TU_TINH_THACH_TRUNG_CAP);
        ...
        LANG_TRUYEN_THUYET.add(3, ItemName.THUY_THACH);
        LANG_TRUYEN_THUYET.add(3, ItemName.PHONG_THACH);
        LANG_TRUYEN_THUYET.add(3, ItemName.HOA_THACH);
        ...
        LANG_TRUYEN_THUYET.add(1.5, ItemName.CHUYEN_TINH_THACH);
        LANG_TRUYEN_THUYET.add(2, ItemName.TU_TINH_THACH_SO_CAP);
        ...
        VDMQ.add(2, ItemName.CHUYEN_TINH_THACH);
        ...
        BOSS.add(5, ItemName.PHIEU_MAY_MAN);
        BOSS.add(1, ItemName.CHUYEN_TINH_THACH);
        BOSS.add(1, ItemName.TU_TINH_THACH_SO_CAP);
        BOSS.add(3, ItemName.VE_VIP);
        

        // Boss vùng đất ma quỷ
        BOSS_VDMQ.add(10, ItemName.DA_CAP_9);
        BOSS_VDMQ.add(10, ItemName.DA_CAP_10);
        BOSS_VDMQ.add(2, ItemName.PHAN_THAN_LENH);
        BOSS_VDMQ.add(3, ItemName.RUONG_SVC_10X);// sách 10x
        BOSS_VDMQ.add(3, ItemName.RUONG_SVC_10X);// sách 10x
        BOSS_VDMQ.add(1, ItemName.SACH_VO_CONG_KAGE_BUNSHIN);//sach9x phan than
        BOSS_VDMQ.add(1, ItemName.SACH_VO_CONG_KAGE_BUNSHIN);//sach9x phan than
        BOSS_VDMQ.add(3, ItemName.TU_TINH_THACH_SO_CAP);
        BOSS_VDMQ.add(3, ItemName.TU_TINH_THACH_TRUNG_CAP);
        BOSS_VDMQ.add(3, ItemName.CHUYEN_TINH_THACH);
        BOSS_VDMQ.add(0.1, ItemName.HARLEY_DAVIDSON);
